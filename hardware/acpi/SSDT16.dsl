 ...
 *
 * Disassembly of SSDT16
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00008859 (34905)
 *     Revision         0x02
 *     Checksum         0xF9
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "0000    "
...
{
    External (_SB_.E1PL, MethodObj)    // 0 Arguments
    External (_SB_.E1UP, MethodObj)    // 0 Arguments
    External (_SB_.E2PL, MethodObj)    // 0 Arguments
    External (_SB_.E2UP, MethodObj)    // 0 Arguments
    External (_SB_.E3PL, MethodObj)    // 0 Arguments
    External (_SB_.E3UP, MethodObj)    // 0 Arguments
    External (_SB_.E4PL, MethodObj)    // 0 Arguments
    External (_SB_.E4UP, MethodObj)    // 0 Arguments
        ...
        Device (TXHC)
        {
            ...
            Device (RHUB)
            {
                ...
                Device (HS01)
                {
                    ...
                    {
                        Return (\_SB.TUPC (Zero, 0xFF, Zero))
                    }

                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Return (\_SB.TPLD (Zero, Zero))
                    }
                }
