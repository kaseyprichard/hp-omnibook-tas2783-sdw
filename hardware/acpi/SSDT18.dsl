...
DefinitionBlock ("", "SSDT", 2, "HPQOEM", "0000    ", 0x00001000)
{
    Scope (\_SB)
    {
        Device (TPM)
        {
            Name (_HID, "INTC7002")  // _HID: Hardware ID
            ...
            OperationRegion (TNVS, SystemMemory, 0x6FE88000, 0x30)
            ...
            OperationRegion (CONA, SystemMemory, 0x6FE88030, 0x30)
            ...
            OperationRegion (STRT, SystemMemory, 0x6FE88060, 0x04)
